...
# Add parent to path. This MUST run before the import below, so the import is
# not at the top of the file and cannot be -- hence the noqa rather than a
# reordering. `tests/test_checkpoint.py` carries the same annotation for the
# same reason.
