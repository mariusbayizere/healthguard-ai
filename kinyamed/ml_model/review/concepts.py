...
CONCEPTS = [
 ...
 ("cardiac_respiratory","CRITICAL","CR03","central cyanosis - blue lips","IMCI: central cyanosis, severe respiratory distress",
 ...
 ("gastrointestinal","CRITICAL","GI04","severe diarrhoea with dehydration","IMCI: SEVERE DEHYDRATION",
  "severe watery diarrhoea and the child has become dehydrated","une diarrhee liquide severe et l'enfant s'est deshydrate"),
