...
\midrule
\textbf{Kinyarwanda} & 165 & -- & 8 & 43 (4/4) & 330,000 \\
English & 0 & 198 & 8 & 10 (1/4) & 0 \\
French & 0 & 194 & 8 & 10 (1/4) & 0 \\
Swahili & 0 & 0 & 7 & 10 (1/4) & 0 \\
\bottomrule
\end{tabular}
...
(english relations wording from the v1 machine drafts; swahili relations speaker authored).}
\label{tab:arms}
\end{table}
